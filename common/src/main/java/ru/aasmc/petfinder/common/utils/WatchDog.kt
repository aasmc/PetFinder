...
class WatchDog {
    ...
    fun deviceCompromised(): Boolean {
        ...
        manufactuer = if (manufactuer != null && manufactuer.trim().isNotEmpty()) {
            manufactuer.lowercase(Locale.US)
        } else {
            ""
        }
