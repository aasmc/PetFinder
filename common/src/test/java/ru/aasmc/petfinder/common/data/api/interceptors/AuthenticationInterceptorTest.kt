...
class AuthenticationInterceptorTest {
    ...
    fun authenticationInterceptor_expiredToken() {
        ...
        Mockito.verify(preferences, Mockito.times(1)).getToken()
        ...
        Mockito.verify(preferences, Mockito.times(1)).putTokenExpirationTime(Mockito.anyLong())
        Mockito.verify(preferences, Mockito.times(1)).putTokenType(ApiParameters.TOKEN_TYPE.trim())
